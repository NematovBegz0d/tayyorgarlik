    ...
    items: [
      {
        ...
        a: "Mehnat bozori global raqamlashtirish va \"yashil iqtisodiyot\" to'lqini ostida tubdan o'zgarmoqda. Kelajakda quyidagi 10 kasbga talab eng yuqori bo'ladi — va men ularning har birini o'quvchiga maqsadli targ'ib qilaman.\n1) Sun'iy intellekt va katta ma'lumotlar muhandisi — mashinani o'ylatadigan odam; 2) Kiberxavfsizlik mutaxassisi — bu mening soham, raqamli dunyoning posboni; 3) Muqobil energiya muhandisi — quyosh va shamol energiyasini boshqaruvchi; 4) Agrotexnolog — aqlli qishloq xo'jaligi, dron va sensorlar bilan ishovchi; 5) Biotexnolog — gen darajasida sog'liqni boshqaruvchi; 6) Raqamli marketolog/targetolog — internet bozorini boshqaruvchi; 7) Robototexnik va dron operatori — zavodlar va logistikani boshqaruvchi; 8) E-commerce menejeri — onlayn savdo zanjirini quradigan; 9) Gerontolog va reabilitolog — keksa avlodga sog'liqni tiklash xizmatini ko'rsatuvchi; 10) Ruhiy salomatlik kouçi — zamonaviy stressga qarshi kurashuvchi.\nBu o'nlikdagi eng qiziqarlisi — barchasi hozir O'zbekistonda ham rivojlanayapti. TATU bitiruvchisi sifatida men, ayniqsa AI, kiberxavfsizlik va robototexnika yo'nalishida o'quvchilarga nafaqat yo'nalish, balki real ko'nikma bera olaman.",
        keys: ["AI/Data Scientist", "kiberxavfsizlik", "muqobil energiya", "agrotexnolog", "biotexnolog", "targetolog", "robototexnik/dron", "e-commerce", "gerontolog", "ruhiy salomatlik kouçi", "O'zbekistonda ham rivojlanayapti"]
      },
      {
      ...
      },
      {
        ...
        a: "Zamonaviy texnologiyalar inson mehnatiga bir necha muhim afzallik olib keldi — va bu faqat quruq nazariya emas, hayotiy haqiqat.\nBirinchi afzallik — masofaviy ishlash imkoniyati. Endi inson Samarqandda o'tirib, Londondagi kompaniya uchun ishlay oladi. Masofa — to'siq emas, faqat internet kerak. Ikkinchi afzallik — yuqori daromad. IT va AI mutaxassislari dunyodagi eng yuqori maoshli kasb egalari sifatida tan olingan — va O'zbekistonda ham IT-Park eksporti milliard dollarlarga yetdi. Uchinchi afzallik — global imkoniyat. Bugun bir O'zbek yoshi Coursera yoki edX orqali MIT darslarini bepul tinglay oladi — bu 20 yil avval mumkin emasdi. To'rtinchi afzallik — og'ir mehnatning yengillashishi. Robot va avtomatlar qo'l mehnatini o'z zimmasiga oldi, inson esa fikrlash va ijod bilan shug'ullana oladi.\nMen maslahatchi sifatida bu afzalliklarni o'quvchilarimga konkret misollar orqali ko'rsataman: \"Sen 18 yoshida uydan chiqmasdan xalqaro kompaniya uchun ishlay olasan\" — bu bugun haqiqat. Maqsadim — o'quvchida texnologiyaga nisbatan qo'rquv emas, ishtiyoq shakllantirish.",
        keys: ["masofaviy ishlash", "IT-Park — milliard dollar eksport", "MIT darslari bepul (Coursera/edX)", "robot qo'l mehnatini oladi — inson ijod qiladi", "18 yoshida xalqaro ish", "qo'rquv emas, ishtiyoq"]
      },
      {
      ...
      },
      {
        ...
        a: "Bugungi kunda eng yuqori daromad keltiradigan kasblar — IT va dasturlash, sun'iy intellekt va data science, kiberxavfsizlik, shifokor-jarroh, moliya tahlilchisi va yuridik maslahatchi. Bularning aksariyati raqamli iqtisodiyot asosida ishlaydi.\nLekin men bu savolga faqat raqam bilan javob bermasligim kerak — chunki mening ishim o'quvchini eng boy emas, eng baxtli qilish.\nShuning uchun men o'quvchilarga doimo uchta savolni birga qo'yaman. Birinchisi — \"Bu kasb seni qiziqtiradimi?\" Ikkinchisi — \"Bu kasbda qobiliyating bormi?\" Uchinchisi — \"Jamiyat bunga muhtojmi?\" Faqat shu uch savol bir joyda uchrashganda — haqiqiy kasb tug'iladi. Va mana shu kasbda inson ham daromad topadi, ham ruhiy qoniqish.\nBugun eng daromadli kasb ertaga o'zgarishi mumkin — chunki bozor o'zgarib turadi. Lekin o'z qiziqishi va qobiliyatiga mos kasb topgan inson — har qanday bozorda yutadi. Chunki sevib qilinadigan ishda inson to'xtamaydi, o'smaydi — parvoz qiladi.",
        keys: ["IT/dasturlash/AI/kiberxavfsizlik/shifokor", "3 savol: qiziqish/qobiliyat/jamiyat ehtiyoji", "daromad + ruhiy qoniqish", "bozor o'zgaradi — qiziqish o'zgarmaydi", "sevib qilingan ish — parvoz"]
      },
      {
      ...
      },
      {
        ...
        a: "Bu — juda nozik va inson taqdiri bilan bog'liq masala. Men bu yerda ham bir tomonlama fikr bildirmayman.\nAfzalliklari haqiqatan katta. Oilaviy kasb — tayyor ustaxona, tayyor mijozlar bazasi, tayyor ustoz. Bola otasi yoki onasining yonida o'sib, kasb sirlarini hayotda o'rganadi — bu hech bir darslikda yo'q. Bundan tashqari, an'anaviy kasblar — non yopish, kulolchilik, duradgorlik — jamiyatda hech qachon talabdan qolmaydi.\nAmmo kamchiligi ham bor: agar bola kasbni majburiy tanlagan bo'lsa, o'zi qiziqmaydigan ishda butun umrini o'tkazishi mumkin. Bu — ham uning uchun azob, ham ish sifatiga zarar.\nMening tamoyilim shu: oilaviy kasbni davom ettirish — sharafli, lekin majburiy emas. Men avval bolaning o'z qiziqishini test va suhbat orqali aniqlayman. Agar kasbga qiziqishi mos kelsa — katta ishtiyoq bilan qo'llayman va uni zamonaviy ko'nikmalar: onlayn savdo, brending, raqamli marketing bilan boyitishga o'rgataman. Agar mos kelmasa — ota-onaga bolaning salohiyatini dalil bilan ko'rsatib, birga muqobil yo'l topamiz.\nChunki bizning vazifamiz bolani kasbga emas — kasbni bolaga moslashtirish.",
        keys: ["tayyor ustaxona/ustoz/mijozlar", "majburlik — azob va sifat zarari", "qiziqishini avval aniqlayman", "onlayn savdo+brending bilan boyitish", "kasbni bolaga moslashtirish"]
      },
      {
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "O'quvchining qiziqishini aniqlash — bu bir daqiqalik test emas, balki izchil va ilmiy jarayon. Men hech qachon bitta usulga tayanmayman, chunki bitta test — to'liq hukm emas.\nMen beshta usulni birlashtiraman. Birinchisi — kuzatuv: o'quvchi qaysi darsda jonlanadi, qaysi mashg'ulotda ko'zlari yonadi — bu o'zi javob. Ikkinchisi — so'rovnoma va anketa: strukturali savollar orqali o'quvchining o'zi bildirgan qiziqishlarini yig'aman. Uchinchisi — ilmiy psixologik test: Holland yoki Klimov metodikasi orqali o'quvchining shaxsiy tipini aniqlayman — Holland 6 toifani ajratadi (realistik, tadqiqotchi, ijodiy, ijtimoiy, tadbirkor, an'anaviy), va har biri alohida kasb yo'nalishiga mos keladi. To'rtinchisi — individual suhbat: o'quvchi bilan yakkama-yakka gaplashib, uning orzulari, qo'rquvlari va ichki sabablari haqida ma'lumot olaman. Beshinchisi — o'quv natijalari tahlili: qaysi fanda yutuq ko'proq — bu ham qiziqishning oynasi.\nBarcha ma'lumotni bir joyga yig'ib, psixolog bilan birgalikda yakuniy tasvir hosil qilaman. So'ng natijani ota-ona bilan muhokama qilaman.\nChunki o'quvchi haqida qaror qabul qilish uchun men taxmin emas — dalil kerak.",
      ...
      },
      {
        ...
        a: "Bu — kasbga yo'naltirishdagi eng ko'p uchraydigan va eng nozik vaziyat. Men bunda hech kimni ayblamayman — ikki tomon ham o'z o'rnida haq.\nBirinchi qadam — tinglayman. Avval o'quvchini tinglayman: uning qiziqishi nima, nima uchun, bu orzusi qachondan beri bor? So'ng ota-onani tinglayman: ularning xavotiri nima — daromadmi, obro'mi yoki boshqa sabab?\nIkkinchi qadam — tasdiqlayman. O'quvchining qiziqishi va qobiliyatini psixologik test, portfolio natijalari va o'quv ko'rsatkichlari bilan dalillash. Quruq gap emas — raqam va fakt bilan.\nUchinchi qadam — tushuntiraman. Ota-onaga zamonaviy mehnat bozorini ko'rsataman: \"Siz xohlagan kasb — munosib. Lekin bolangizning qiziqishi bor kasb ham munosib, daromadli va istiqbolli.\" Har ikkala yo'lning imkoniyatlarini ro'yxat qilib ko'rsataman.\nTo'rtinchi qadam — «oltin o'rta» topaman. Ko'p hollarda ikkala tomon ham qoniqadigan yo'l bor — masalan, ota-ona shifokorni, bola IT ni xohlasa — bioinformatika yoki tibbiy kibernetika.\nBeshinchi qadam — psixolog ishtirokida uch tomon kelishuvi. Yakuniy qarorni o'quvchi, ota-ona va men — birgalikda qabul qilamiz.\nMening tamoyilim: kelajakda shu kasb bilan yashaydigan — bola. Shuning uchun bolaning ovozi eng og'ir tarozida turadi.",
        keys: ["tinglayman — ikki tomonni", "test/portfolio/ko'rsatkich — dalil", "mehnat bozorini ko'rsataman", "oltin o'rta: bioinformatika/tibbiy kibernetika", "uch tomon kelishuvi", "bolaning ovozi — eng og'ir"]
      },
      {
        q: "27. Hech narsaga qiziqmaydigan o'quvchi bilan qanday ishlaysiz?",
        a: "Men bir qoidaga qat'iy ishonaman: \"Qiziqmaydigan bola yo'q — o'z qiziqishini hali topmagan bola bor.\" Shuning uchun bunday o'quvchini men muammo emas, kashfiyot kutayotgan kimsa deb ko'raman.\nBirinchi qadam — tashxis. Psixolog bilan birgalikda sababini aniqlayman. Bu loqaydlik qayerdan kelyapti — oilaviy muammomi, o'ziga ishonchsizlikmi, charchoqmi, yoki bola shunchaki hali o'zini topmaganmi? Sabab har xil bo'ladi — davo ham har xil bo'ladi.\nIkkinchi qadam — kenglik. Uni turli faoliyatga jalb qilaman: Turon teatr, Debat, Eco-schools, IT to'garagi, sport. Maqsad — ko'proq eshikni ochib berish, shoyad bittasida chiroq yonsin.\nUchinchi qadam — kichik muvaffaqiyat. Unga bitta kichik, lekin erishish mumkin bo'lgan vazifa beraman. Misol: \"Ertaga sinfga kichik taqdimot qil.\" U uddalaganda — katta maqtov. Birinchi muvaffaqiyat uchqun yoqadi, uchqundan alanga ko'tariladi.\nTo'rtinchi qadam — «Haqiqiy hayot hikoyasi» metodi. Tumandagi o'z yo'lini topgan yosh muvaffaqiyat egalarini taklif qilaman — tengdosh misol kitobdan kuchliroq.\nMen sabr bilan, individual yondashaman. Chunki iqtidor — o'z vaqtida yonadi. Mening vazifam — shu vaqt kelguncha sham tutib turish.",
        keys: ["qiziqmaydigan bola yo'q — hali topmagan", "psixolog bilan sabab (oila/ishonchsizlik/charchoq)", "turli faoliyat — ko'p eshik", "kichik muvaffaqiyat — uchqun", "Haqiqiy hayot hikoyasi metodi", "sham tutib turish"]
      },
      {
      ...
      },
      {
        ...
        a: "Men bunday xohishni to'liq qo'llayman — chunki bu bola uchun eng yaxshi imkoniyatlardan biri bo'lishi mumkin. Lekin bu yo'l tayyorgarliksiz boshlanmaydi.\nAvval niyatning asosini aniqlayman: bola chet elda o'qishni chinakam bilim olish uchun xohlayaptimi, yoki shunchaki fashionmi? Bu farq — maqsadli tayyorgarlik va samarasiz xarajat o'rtasidagi farq.\nKeyin amaliy rejani tuzaman. Birinchidan, til: IELTS yoki TOEFL sertifikatisiz xorijiy oliygoh yo'q — shuning uchun Xorijiy tillar klubiga jalb qilaman. Ikkinchidan, GPA: yuqori o'quv ko'rsatkichi har qanday oliygohdagi eng kuchli hujjat. Uchinchidan, grant: \"El-yurt umidi\", Erasmus+, DAAD, Chevening kabi grantlar bor — ularning shartlarini birga o'rganamiz. To'rtinchidan, hujjat: motivatsion xat, tavsiya xati va CV yozishda hamrohlik qilaman — bu jarayon murakkab, ammo men bilaman. Beshinchidan, xavfsizlik: firibgar konsalting firmalaridan ogohlantiraman, universitetlarni rasmiy saytdan tekshirtirilaman.\nVa eng muhimi — \"brain drain emas, brain gain\" g'oyasini singdiraman. Chet elda o'qib, tajriba olib qaytgan inson — mamlakatga eng katta hissa qo'shadigan fuqaro. Shuning uchun xorijda o'qish — ketish emas, kuchlanish va qaytish.",
        keys: ["niyat asosini aniqlayman", "IELTS/TOEFL", "yuqori GPA", "El-yurt umidi/Erasmus+/DAAD/Chevening", "motivatsion xat/CV hamrohlik", "firibgardan ogohlantirish", "brain gain — qaytib kuchlanish"]
      },
      {
        q: "33. O'quvchi OTMga kirishdan umidini uzgan bo'lsa?",
        a: "Umidsizlik — bu mening uchun signal: bu bola yordam kutmoqda. Men bunday holatda birinchi navbatda ayblamayman va shoshiltirmayman.\nBirinchi qadam — sabab. Psixolog bilan birgalikda chuqur suhbat qilaman: nima uchun umidsizlik? Bilim yetishmovchiligimi, oilaviy bosimmi, muvaffaqiyatsizlik qo'rquvimi, yoki oddiygina yo'lini topolmayotganmi? Har qaysi sababning o'z yechimi bor.\nIkkinchi qadam — ishonch. Unga o'xshash vaziyatdan chiqqan muvaffaqiyat hikoyalarini ko'rsataman. \"Men sening ahvolimga tushib, keyin qo'lga kiritgan\" degan tengdosh misoli — eng kuchli motivatsiya.\nUchinchi qadam — kichik maqsadlar zanjiri. Katta orzudan qo'rqqan odamga kichik qadamlarni ko'rsataman. Har bir kichik yutug'ini tantana bilan ta'kidlayman — chunki o'z kuchiga ishonch qayta-qayta muvaffaqiyatdan quriladi.\nTo'rtinchi qadam — muqobil yo'llar. OTM — yagona yo'l emas. Kasb-hunar ta'limi, MOOC kurslar, \"Ishga marhamat\" monomarkazi, kechroq topshirish — bularning har biri to'laqonli hayotga olib boradi. Men bu yo'llarni ulug'lab ko'rsataman.\nBeshinchi qadam — fan o'qituvchisiga biriktirish. Zaif fanlarni MOCK imtihonlari bilan mustahkamlaymiz, real reja tuzamiz.\nMaqsadim — bu o'quvchi \"men ham qila olaman\" degan ishonch bilan tashqariga chiqsin. Chunki iqtidor hech qachon umidsizlikka teng kelmaydi.",
        keys: ["sabab: bilimmi/bosimmi/qo'rquvmi", "muvaffaqiyat hikoyasi — tengdosh misol", "kichik maqsadlar zanjiri", "OTM — yagona yo'l emas (kasb-hunar/MOOC/monomarkaz)", "fan o'qituvchisi + MOCK", "iqtidor — umidsizlikka teng kelmaydi"]
      },
      {
      ...
      {
        q: "34e. Klublar oliy ta'limga kirishda qanday yordam beradi?",
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Bu — mening eng sevimli mavzularimdan biri. Chunki TATU bitiruvchisi sifatida men IT sohaning ichidan bilaman: bu sohada qizlarga joy bor, imkoniyat bor, kelajak bor.\nBirinchi qadam — stereotipni buzaman. \"IT — faqat o'g'il bolalar uchun\" degan qarashni faktlar bilan sindiraman: dunyodagi eng yirik IT kompaniyalarida ayollar muhim lavozimlarni egallaydi; O'zbekistonda ham muvaffaqiyatli IT-ayollar bor — ularni maktabga taklif qilaman.\nIkkinchi qadam — qulay kirish nuqtasi. Men qizlarga murakkab koddan emas — qiziqarli va ko'rinadigan loyihalardan boshlayman. O'z Instagram sahifasini Canva'da dizayn qilish, oddiy chatbot yaratish, maktab tanloviga veb-sahifa tayyorlash. Bola «men buni qila olaman» deganda — darvoza ochiladi.\nUchinchi qadam — men o'zim o'rgataman. TATU bitiruvchisi sifatida dasturlash asoslari, AI, Canva, SMM, copywriting darslarini bevosita men beraman. Bu — quruq ma'ruza emas, amaliy mashg'ulot.\nTo'rtinchi qadam — rag'bat tizimi. Eng faol a'zolarga sertifikat, maktab sahifasida ta'rif, IT-Park ekskursiyasi. Tan olingan qiz — qoladi va boshqalarni ham tortadi.\nBeshinchi qadam — real loyihaga yo'naltirish. «Raqamli avlod qizlari» tanloviga tayyorlayman — bu qizga nafaqat tajriba, balki grant va xorijiy sayohat imkoniyatini beradi.\nMaqsadim — har bir qizning g'oyasi real mahsulotga aylansin.",
      ...
      },
      {
        ...
        a: "Komissiya bu savolni berganida — raqamlarni bilishingizni tekshirayapti. Men ularni aniq bilaman.\nAsosiy talablar:\n• Faqat jonli ijro — audio fonogramma qat'iyan taqiqlanadi\n• Qo'shiq ijro etilmaydi — faqat milliy cholg'u asboblari\n• Chiqish vaqti — 6 daqiqagacha\n• Baholash tizimi — 40 ball\nBallar qanday taqsimlanadi? Ijro mahorati, ansambl uyg'unligi, milliy cholg'ulardan foydalanish, sahna madaniyati, musiqiy savodxonlik va badiiy talqin — oltita mezon bo'yicha baholanadi.\nNima uchun jonli ijro majburiy? Chunki tanlovning maqsadi — haqiqiy iqtidorni aniqlash. Fonogramma bilan kim ham chiroyli chiqishi mumkin — lekin bu mahorat emas.\nRespublika g'olibi xorijiy davlatga ta'lim sayohatini qo'lga kiritadi — bu o'quvchilar uchun eng kuchli rag'bat.\nMen o'quvchilarimni bu talablarga bosqichma-bosqich tayyorlayman: avval mashq, so'ng sinov chiqishi, so'ng real tanlov. Chunki sahnaga tayyorsiz chiqish — o'quvchiga ishonch emas, qo'rquv beradi.",
        keys: ["jonli ijro — fonogramma taqiq", "faqat milliy cholg'u", "6 daqiqa", "40 ball — 6 mezon", "g'olib — xorijiy sayohat", "bosqichma-bosqich: mashq → sinov → tanlov"]
      },
      {
        q: "99. Iqtidor ansambli tanlovi o'quvchiga nima beradi?",
        a: "\"Iqtidor ansambli\" — bu nafaqat musiqa tanlov, balki o'quvchini hayot uchun tayyorlaydigan kompleks tarbiyaviy tajriba.\nBirinchidan — milliy san'atga muhabbat. O'quvchi dombra yoki g'ijjakni qo'liga olganda, u ajdodlaridan meros qolgan tilga murojaat qiladi. Bu tuyg'u — hech bir darsda berib bo'lmaydigan narsa.\nIkkinchidan — jamoaviy uyg'unlik. Ansamblda har bir cholg'u o'z vaqtida chalishi kerak — biri noto'g'ri qilsa, hammasiga ta'sir qiladi. Bu — jamoaviy mas'uliyatning eng chuqur o'quvi. Hayotda ham shunday: jamoaning muvaffaqiyati har bir a'zoga bog'liq.\nUchinchidan — sabr va mashq madaniyati. Yaxshi ijroga bir kunda erishilmaydi. O'quvchi haftalab mashq qilib, natijani ko'radi — bu unga «mehnat meva beradi» degan hayotiy saboqni beradi.\nTo'rtinchidan — sahna madaniyati va o'ziga ishonch. Yuz odamning oldida turish va chalisholish — bu yosh uchun katta jasorat. Shu jasorat keyinchalik hayotning barcha sohalarida asqotadi.\nBeshinchidan — «Prezident iqtidorli farzandlari» dasturiga yo'l. Ansamblda ko'zga tashlanuvchi o'quvchi — iqtidorlilar ro'yxatiga tushadi. Bu unga katta kelajak imkoniyatlarini ochib beradi.\nXulosa: Iqtidor ansambli o'quvchiga milliy ildiz, jamoaviy ruh, sabr va sahna jasoratini bir vaqtda beradi.",
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Bu — bugungi kunda juda ko'p oilada uchrashgan holat. Va men bu yerda ikki tomon o'rtasida bo'linmayman — ikkalasini ham to'g'ri deb bilaman.\nAvval o'quvchini tinglayman: uning Yevropa madaniyatiga qiziqishi nima bilan bog'liq — til, musiqa, kino, san'at, yashash tarzi? Bu qiziqish — tabiiy va rivojlanish belgisi. Keyin ota-onani tinglayman: ularning xavotiri nima — milliy o'zlik yo'qolishimi, qadriyatlar buzilishimi?\nSo'ng men ikkalasiga ham muhim haqiqatni aytaman: boshqa madaniyatni o'rganish — milliy o'zlikni yo'qotmaydi, aksincha boyitadi. Bir tilda gaplashadigan, ikki madaniyatni biladigan inson — kuchliroq, raqobatbardoshroq.\nAmaliy yondashuv: o'quvchini Xorijiy tillar klubiga yo'naltiraman — u yerda xorijiy madaniyatni o'rganadi. Ayni paytda Jadidlar izidan klubi orqali milliy merosni ham rivojlantiradi. Bu ikki klub birgalikda — muvozanatni ta'minlaydi.\nOta-onaga shuni tushuntiraman: taqiqlash — qiziqishni yo'qotmaydi, faqat yashiradi. Yo'naltirish — bu bolani himoya qilishning aqlli usuli.\nMaqsadim — o'quvchi milliy ildiziga sodiq, lekin dunyoga ochiq inson bo'lib yetishsin. Chunki eng kuchli daraxt — ildizi chuqur, lekin shoxlari keng yoyilgan daraxt.",
        keys: ["ikkala tomonni tinglayman", "boshqa madaniyat — o'zlikni boyitadi", "Xorijiy tillar klubi + Jadidlar izidan", "taqiqlash emas, yo'naltirish", "milliy ildiz + dunyoga ochiq", "ildizi chuqur — shoxlari keng"]
      },
      {
      ...
      },
      {
        ...
        a: "Bu keys meni eng ko'p qo'zg'aydigan vaziyatlardan biri — chunki bu yerda nafaqat kelajak, balki bolaning o'ziga ishonchi ham xavf ostida.\nBirinchi qadam — tinchlantiraman. Panikaga tushmasdan, ayblamasdan, shoshiltirmasdan — faqat tinglaman. Chunki umidsiz inson avval eshitilishni xohlaydi.\nIkkinchi qadam — sababni aniqlayman. Psixolog bilan birgalikda ko'raman: bu bilim yetishmovchiligimi — u tuzatiladi. Qo'rquvmi — u yengiladi. Oilaviy bosimmi — u hal qilinadi. Har bir sababning o'z yechimi bor.\nUchinchi qadam — muvaffaqiyat hikoyasi. Unga o'xshash vaziyatdan chiqqan, hozir muvaffaqiyatli bo'lgan odamning hikoyasini aytaman. Tengdosh misol — eng kuchli motivatsiya.\nTo'rtinchi qadam — kichik maqsadlar. Katta orzudan qo'rqib qolgan odamga: \"Bugun faqat bitta bob o'qi\" deyman. Har bir kichik yutug'ini tantana qilaman — ishonch shu tarzda qayta quriladi.\nBeshinchi qadam — muqobil yo'llar. OTM — yagona yo'l emas. Kasb-hunar kolleji, MOOC kurslar, \"Ishga marhamat\" monomarkazi, kechroq topshirish — bularning har biri muvaffaqiyatga olib boradi. Men bu yo'llarni kamsitmasdan, ulug'lab ko'rsataman.\nOldinchi qadam — amaliy reja. Fan o'qituvchisiga biriktiraman, MOCK imtihonlar o'tkazaman va har hafta natijasini birgalikda ko'raman.\nMaqsadim bitta — bu o'quvchi kabinetdan \"men ham qila olaman\" deb chiqsin.",
        keys: ["tinchlantiraman, ayblamayman", "psixolog bilan sabab", "tengdosh muvaffaqiyat hikoyasi", "kichik maqsadlar — ishonch quriladi", "OTM yagona yo'l emas", "fan o'qituvchisi + MOCK", "men ham qila olaman"]
      },
      {
      ...
      },
      {
        ...
        a: "Bu — format bilan bog'liq muammo, va men buni o'quvchi aybdor deb emas, men tomondan o'tilmagan deb qabul qilaman.\nSabab oddiy: passiv tomosha — zerikadi. O'quvchi ekranga qaraydi, lekin miyasi boshqa joyda.\nShuning uchun men formatni tubdan o'zgartiraman. Videoni ko'rsatishdan oldin — qiziqish uyg'otaman. \"Bu videoda bitta yashirin sir bor — topasizmi?\" yoki \"3 daqiqadan keyin siz savol olasiz\" deyman. Bu — miyani faol rejimga o'tkazadi.\nVideo davomida — to'xtataman. Muhim lahzada videoni pauza qilaman va savol beraman: \"Siz bu odamning o'rnida bo'lsangiz nima qilardingiz?\" Javob olaman, muhokama qilaman, keyin davom ettiraman.\nVideodan keyin — amaliy vazifa. Har bir o'quvchiga 2 daqiqa ichida javob topishni so'rayman: \"Bu kasbda eng qiyin nima ekan? Google'dan top.\" Yoki: \"Bu kasbda O'zbekistonda eng ko'p maosh to'laydigan kompaniya qaysi?\"\nEng samarali usul — o'quvchilarning o'zlariga video tayyorlatish. \"Siz bir kasbni tanlang va 1 daqiqalik video qiling\" — bu tayyorlash jarayonida kasbni chuqur o'rgantiribgina qolmay, ijodkorlik va jamoaviy ishni ham rivojlantiradi.\nTamoyilim: o'quvchi tomoshabin bo'lganda zerikadi — ishtirokchi bo'lganda qiziqadi. Format o'zgarsa — natija ham o'zgaradi.",
        keys: ["passiv tomosha — zerikadi", "oldin qiziqish uyg'otish", "videoni pauza qilish + savol", "amaliy vazifa: Google + qidirish", "o'quvchilar o'zlari video tayyorlaydi", "tomoshabin emas, ishtirokchi"]
      },
      {
